...
namespace FudballManagement.Infrastructure.Migrations
{
    ...
    [Migration("20250516193630_FirstLastOne")]
    partial class FirstLastOne
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FudballManagement.Domain.Entities.Stadiums.Stadium", b =>
                {
                    ...
                    b.Property<long>("StadiumLocationId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FudballManagement.Domain.Entities.Stadiums.StadiumLocation", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FudballManagement.Domain.Entities.Stadiums.StadiumLocation", b =>
                {
                    b.HasOne("FudballManagement.Domain.Entities.Stadiums.Stadium", "Stadium")
                        .WithOne("Location")
                        .HasForeignKey("FudballManagement.Domain.Entities.Stadiums.StadiumLocation", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
